<template>
  <div class="mt-[7rem] text-center">
    <h1 class="text-7xl ">Bem-vindo a <br> <span class="text-[]">Fedora's Weather</span>!</h1>
  ...
  <div class="bottom-0 left-3 absolute">
    <a href="https://github.com/Wecreds/FedoraWeather">
    <img src="../../public/icon.png" class="w-1/12 cursor-pointer">
  </a>
  </div>
</template>
